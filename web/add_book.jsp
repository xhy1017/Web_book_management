...
<script>
    $(function (){
        ...
        {
            if(validateform()===true)//post请求
            {$.post("AddBookServlet",$("#bookform").serialize(),function (data,status) {
                alert(data);
                console.log(status);
...
<form  onsubmit="return validateform()" id="bookform"  enctype="application/x-www-form-urlencoded">
...
<tr>
    <td>是否借出:</td>
    <td>
            <select name="bkStatus" class="form-control col-md-3" >
